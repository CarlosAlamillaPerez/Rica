...
{
    options.Cookie.Name = "LMS.Bepensa2025";
...
.AddCookie(CookieAuthenticationDefaults.AuthenticationScheme, options =>
{
    ...
    options.Cookie.Name = "LMS.BepensaAuth";
...
app.Use(async (ctx, next) =>
{
    var sitesImgUrl = builder.Configuration.GetValue<bool>("Global:Produccion") ?
        ...
        "https://localhost:4477/ http://localhost:30760 http://localhost:5156 https://localhost:5156";
