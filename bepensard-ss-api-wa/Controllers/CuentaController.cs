...
namespace bepensard_ss_api_wa.Controllers
{
    ...
    {
        private readonly IConsultasCuentaRDProxy _movementsApp;
        private readonly IUsuarioRD _usuario;
        public CuentaController(IConsultasCuentaRDProxy movementsApp, IUsuarioRD usuarios)
        {
