...
public partial class BepensaRD_Context : DbContext
{
    public BepensaRD_Context(DbContextOptions<BepensaRD_Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ImagenesPromocione>(entity =>
        {
            ...
            entity.HasOne(d => d.IdProgramaNavigation).WithMany(p => p.ImagenesPromociones)
                .HasForeignKey(d => d.IdPrograma)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ImagenesPromociones_Programas");
        });
