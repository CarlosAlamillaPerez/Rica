...
{
    public class ConsultaCuentaProxy:ProxyBase,IConsultasCuentaProxy
    {
        private readonly IConfiguration _configuration;
        private readonly GlobalSettings _ajustes;
        private readonly SmsSettings _smsAjustes;
        public ConsultaCuentaProxy(BepensaContext Context, IConfiguration Configuracion, IOptionsSnapshot<GlobalSettings> ajustes, IOptionsSnapshot<SmsSettings> smsAjustes)
        {
            DBContext = Context;
        ...
        public Respuesta<ResponseCuentaPrivacidad> ConsultaCliente(RequestCliente data)
        {
            ...
            try
            {
                ...
                if (usuario.IdPrograma == (int)TipoCanal.Comidas)
                {
                    resultado.Data.urlAvisoPrivacidad = Convert.ToString(_configuration["SettingsUrlPrivacidad:siteUrlPrivacidadComidas"]);
                    resultado.Data.urlPlaystore = "";
                    resultado.Data.urlAppleStore = "";
                }

                if (usuario.IdPrograma == (int)TipoCanal.Tradicional)
                {
                    resultado.Data.urlAvisoPrivacidad = Convert.ToString(_configuration["SettingsUrlPrivacidad:siteUrlPrivacidadTradicional"]);
                    resultado.Data.urlPlaystore = "";
                    resultado.Data.urlAppleStore = "";
                }
        ...
        public async Task<Respuesta<Empty>> RecuperarPassword(RequestRecuperaPass data)
        {
            ...
            try
            {
                ...
                Usuario usuario = DBContext.Usuarios.FirstOrDefault(x => x.Cuc == data.Cliente);
